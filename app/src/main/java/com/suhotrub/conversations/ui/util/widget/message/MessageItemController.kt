...
class MessageItemController(val onClickListener: (MessageDto) -> Unit) : BindableItemController<MessageDto, MessageItemController.Holder>() {
    ...
    inner class Holder(parent: ViewGroup?) : BindableViewHolder<MessageDto>(parent, R.layout.item_message_received) {
